  ...
  return (
    <div className='footer-container '>
      ...
      <div className='row'>
        ...
        <div className='col-md-4 mt-4'><h4>100% safe & Instant payments</h4></div>
      ...
      <div className='row'>
        <div className='col-md-4'>
          Betzhub.co is Asia’s one of the biggest gaming platforms with over 350 games and sports available.<br />
