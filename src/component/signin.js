    ...
    <div className="signInPopup">
      <div className="signInContainer">
        ...
        <div className='container'>
          <div className='row'>
            <center><img alt="logo" src={logo} id='logo' /></center>
          </div>
          <div className='row'>
            <div className='col-md-6'>
              <img src={fiveImage} alt="Left Image" id="imgcard" />
              <h4 id='withdraw'><b>100% <span>FAST</span> Withdrawal</b></h4>
              <img src={subpayment} alt="Left Image" style={{ width: '100%', marginLeft: '5%', }} />
