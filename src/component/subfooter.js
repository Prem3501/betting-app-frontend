  ...
  return (
    <div className='row'>
      <div className='col-md-1'>
        <FontAwesomeIcon icon={faWhatsapp} size="2xl" onClick={handleWhatsAppClick} style={{ color: "white" }} />
      </div>
      <div className='col-lg m-2'>WhatsApp</div>
      <div className='col-md-1 '>
        <FontAwesomeIcon icon={faTwitter} size="2xl" style={{ color: "white", marginLeft: "-2px" }} />
      </div>
