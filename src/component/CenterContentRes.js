...
import './CenterContentRes.css';


function CenterContentRes() {
    return (
        <div className="res-container">
            ...
            <p>
                ...
                <br/>
                https://Betzhub.co is operated by Jubilee Hills N.V.  having its office at Zuikertuintjeweg Z/N (Zuikertuin Tower), Curaçao with Company Registration number 161335.
                ...
                ● Website refers to https://Betzhub.com
                ...
                ● email: info@Betzhub.com Our Support will of course not give out any information about You without Your consent to anyone else
                ...
                email: info@Betzhub.com
                Please keep in mind that Self Exclusion is permanent for the set time span and will not be undone for your own protection.
                <br/>

                During Self Exclusion you are not allowed to create a new Account and every attempt to create a new Account during Self Exclusion is a violation of our Terms of Service and may result in the permanent ban of your original account. <br/>
                <br/>
                <br/>
            </p>
        </div>
...
export default CenterContentRes;