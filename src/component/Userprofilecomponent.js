...
import { faUser, faPhone, faEnvelope, faLock, faChartSimple } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className='row'>
      <div className='col-md-3' id='userdetails'>
        <div className='text-center' style={{ margin: '2pc' }}>
          <FontAwesomeIcon icon={faUser} style={{ color: "#A7110C" }} size='2x' />
          <br />
      ...
      <div className='col-md-8' id='usercount'>
        <div className='row'>
          <h2 id="uservalues">Statistics <FontAwesomeIcon icon={faChartSimple} size='xl' /></h2>
        </div>
        <div className='row'>
