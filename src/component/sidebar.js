              ...
              <div className="list-group list-group-flush mx-3 mt-4">
                <a href="#" className="list-group-item list-group-item-action py-2 ripple" aria-current="true">
                    <div className="row">
                        ...
                        <div className="col-md-4"><span>All Sports</span></div>
                        <div className="col-md-4"><img alt="" src={Add} /></div>
                        </div>
                ...
                <div className="row">
                        ...
                        <div className="col-md-4"><span>Cricket</span></div>
                        <div className="col-md-4"><img alt="" src={Add} /></div>
                        </div>
                ...
                <div className="row">
                        ...
                        <div className="col-md-4"><span>Tennis</span></div>
                        <div className="col-md-4"><img alt="" src={Add} /></div>
                        </div></a>
                ...
                <div className="row">
                        ...
                        <div className="col-md-4"><span>Soccer</span></div>
                        <div className="col-md-4"><img alt="" src={Add} /></div>
                        </div>
                ...
                <div className="row">
                        ...
                        <div className="col-md-4"><span>Australian Rules</span></div>
                        <div className="col-md-4"><img alt="" src={Add} /></div>
                        </div>
                        </a>
                        <a href="#" className="list-group-item list-group-item-action py-2 ripple">
                <div className="row">
                        ...
                        <div className="col-md-4"><span>Esports</span></div>
                        </div>
                        </a>
                        <a href="#" className="list-group-item list-group-item-action py-2 ripple">
                <div className="row">
                        ...
                        <div className="col-md-4"><span>IceHockey</span></div>
                        </div>
                        </a>
                ...
                <div className="row">
                        ...
                        <div className="col-md-4"><span>Boxing</span></div>
                        </div>
                        </a>
                ...
                <div className="row">
                        ...
                        <div className="col-md-4"><span>Mixed Martial Arts</span></div>
                        </div>
                        </a>
                ...
                <div className="row">
                        ...
                        <div className="col-md-4"><span>Motorsport</span></div>
                        </div>
                        </a>
                <a href="#" className="list-group-item list-group-item-action py-2 ripple">
                <div className="row">
                        ...
                        <div className="col-md-4"><span>Politics</span></div>
                        </div>
                        </a>
                        <a href="#" className="list-group-item list-group-item-action py-2 ripple">
                    <div className="row">
                        ...
                        <div className="col-md-4"><span>Handball</span></div>
                        </div>
                        </a>
                    <a href="#" className="list-group-item list-group-item-action py-2 ripple">
                    <div className="row">
                        ...
                        <div className="col-md-4"><span>Rugby Union</span></div>
                        </div>
                        </a>
                    <a href="#" className="list-group-item list-group-item-action py-2 ripple">
                    <div className="row">
