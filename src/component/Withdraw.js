...
class Withdraw extends React.Component {
  ...
  render() {
    const inputLabel = this.state.selectedOption === 'aadharcard' ? 'Aadhar Card' : 'Pancard';
        ...
        <div className='row'>
          <div className='col-md-6'>
            <div className="form-floating">
              ...
              >
                <option value="aadharcard" id='options'>Aadhar Card</option>
                <option value="pancard" id='options'>Pancard</option>
              </select>
              <label htmlFor="floatingSelect" id='labelproof'>Identity Proof <span style={{ color: 'red' }}>*</span> </label>
            </div>
            <br />
            <div className="form-floating">
              <input
              ...
              />
              <label htmlFor="floatingInputValue" id='labelproof'>{inputLabel}</label>
              {validationError && (
  ...
  <div className='row'>
    <div className="col-md-6 document-uploader">
      <FileUploader label="Front Document" onUploadStatus={this.handleUploadStatus} />
    </div>
    <div className="col-md-6 document-uploader">
      <FileUploader label="Back Document" onUploadStatus={this.handleUploadStatus} />
    </div>
    <br/><br/>
    
  </div>
</div>
<div className="col-md-12 text-center"> {/* Center align the button */}
      <button className='btn btn-danger' id='submitbtn'>Submit</button> {/* Add 'btn-md' class for medium size */}
    </div>
        </div>
