...
function CenterContainerKYC(){
    return(
        ...
        <h1> KYC Policy </h1> 
        <p> When a user makes an aggregate lifetime total of deposits exceeding EUR 2000 or requests a withdrawal of any amount inside the https://Betzhub.co platform, then it is compulsory for them to perform a full KYC process.  

        <br />
        During this process, the user will have to input some basic details about themselves and then upload
        <br />
        <br />
        1. A copy of Government Issued Photo ID (in some cases front and back depending on the document)
        ...
        1. Proof of ID
        a. Signature should be there in the document
